...
const HomePage = () => {
  ...
  return (
    <>
      ...
      {/* Title */}
      <h1 className="text-4xl font-bold text-center" style={{color: 'white' }}>Search GitHub Profile</h1>
...
<form form className="form-control my-5">
  <div className="flex justify-center space-x-3">
    ...
    <button
      ...
      style={{ backgroundColor: '#ff8c00', color: 'white' }} // Add inline styles for color
    >
      Search
    </button>
  </div>
