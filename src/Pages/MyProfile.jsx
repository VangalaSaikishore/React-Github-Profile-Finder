...
const MyProfile = () => {
  ...
  useEffect(() => {
    const apiCall = setTimeout(() => {
      axios.get("https://api.github.com/users/VangalaSaikishore").then((res) => setData(res.data));
      axios.get("https://api.github.com/users/VangalaSaikishore/repos").then((res) => setRepos(res.data));
    }, 1500);
  ...
  return (
    <>
      ...
      <div className="items-center flex flex-col mb-5 px-5 h-auto">
        {/* Page title */}
        <h1 className="text-4xl font-bold my-5 text-center" style={{color: '#ceff00' }}>
          My GitHub Profile
        </h1>
            ...
            <div className="card lg:card-side card-bordered border-white flex md:px-5 py-5 w-full md:w-5/12">
              ...
              <div className="card-body flex items-center p-0 sm:p-5">
                ...
                <div className="location mt-3 flex items-center">
                  <GoLocation />
                  <p className="ml-2 text-xl font-bold my-3" style={{color: '#fffacd'}}>{data.location}</p>
                </div>
                ...
                <div className="card-actions">
                  <a href={`${data.html_url}`} className="btn btn-outline font-bold my-3" style={{color: 'black'}}>
